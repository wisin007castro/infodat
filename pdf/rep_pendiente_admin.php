...
if ($id_cliente == 'TODOS') {
    $pedidos = $conexion->rep_dev_admin();
}
else{
...
<h5 align="center"><b>CONSULTAS INGRESADAS NO DEVUELTAS POR CLIENTE </b></h5>
...
if($pdfs){
    ...
    $dompdf->stream(
        "Reporte_pendiente_All-".$f_inicio."-".$f_fin.".pdf", array('Attachment' => true)
    );
}
?>

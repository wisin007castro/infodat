<?php 
	...
	$pedidos = $conexion->id_devoluciones($id_sol);
	// var_dump($pedidos);
...
<table class="table">
  <tr>
    <td style="font-size:18px;"><b>No. Consulta: </b>
    	<?php echo $pedidos[0]['ID_DEV']; ?></td>
    <td align="center"><h4>FORMULARIO 102</h4>
  		<h4>SOLICITUD DE DEVOLUCION DE CONSULTAS</h4></td>
  ...
  <b>FECHA PROGRAMADA: </b><?php echo $pedidos[0]['FECHA_PROGRAMADA']; ?> 
  <hr>
